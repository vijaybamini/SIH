alter table public.bulk_buyers rename column business_name to name;
alter table public.bulk_buyers drop column business_type;
alter table public.bulk_buyers drop column gstin;
alter table public.bulk_buyers add column address text;
alter table public.bulk_buyers add column pincode text;
alter table public.bulk_buyers add column rating numeric(2, 1) not null default 0 check (rating between 0 and 5);
