...
create index fleet_vehicles_provider_idx on public.fleet_vehicles(logistics_provider_id);
...
create policy "Logistics providers can view their own fleet" on public.fleet_vehicles for select using (auth.uid() = logistics_provider_id);
create policy "Logistics providers can add their own fleet" on public.fleet_vehicles for insert with check (auth.uid() = logistics_provider_id);
create policy "Logistics providers can update their own fleet" on public.fleet_vehicles for update using (auth.uid() = logistics_provider_id);
create policy "Logistics providers can delete their own fleet" on public.fleet_vehicles for delete using (auth.uid() = logistics_provider_id);
